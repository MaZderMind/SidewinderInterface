...
#define LCD_CMD_DIR			DDRF		// Data Direction Register for Command Port

#define LCD_DATA_IN			PINK		// Data Input Register
#define LCD_DATA_OUT		PORTK		// Data Output Register
#define LCD_DATA_DIR		DDRK		// Data Direction Register for Data Port

// Command Port Bits
#define D_I					PF3		// D/I Bit Number
#define R_W					PF4		// R/W Bit Number
#define EN					PF5		// EN Bit Number
#define CSEL1				PF7		// CS1 Bit Number
#define CSEL2				PF6		// CS2 Bit Number

#define LCD_W				128		// LCD Width
#define LCD_H				64		// LCD Height
